...
global $wpdb;
 ...
 $page_id=$wpdb->get_var($wpdb->prepare("SELECT page_id FROM $table_name WHERE name = %s",'Listing Single View'));
if(!$page_id){return 'error_not_found';}
