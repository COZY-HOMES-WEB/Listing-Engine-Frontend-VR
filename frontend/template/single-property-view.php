...
$property = $wpdb->get_row($wpdb->prepare(
    "SELECT * FROM {$wpdb->prefix}ls_property WHERE id = %d",
    $property_id
));
...
$desc_truncated = mb_strlen($description) > 300 ? mb_substr($description, 0, 300) . '...' : $description;
$show_desc_more = mb_strlen($description) > 300;
