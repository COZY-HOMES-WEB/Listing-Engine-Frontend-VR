 ...
 * Last Modified: 2026-04-16 - Disabled "close on overlay click" behavior for all popups. Modals now only close via explicit close icons to prevent accidental dismissal.
 *
