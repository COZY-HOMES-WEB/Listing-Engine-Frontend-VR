...
const LEF_Confirm = {
  ...
  init() {
    ...
    if (this.modal && !this.modal.dataset.eventsBound) {
      this.modal.querySelector("#lef-confirm-no").onclick = () =>
        this.close(false);
      this.modal.querySelector("#lef-confirm-yes").onclick = () =>
        this.close(true);
  ...
  open(options, callback) {
    ...
    document.getElementById("lef-confirm-title").innerText =
      options.title || "Confirm Action";
    document.getElementById("lef-confirm-message").innerText =
